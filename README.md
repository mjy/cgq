...
4. `Taxon difference ("s_taxon_difference")` - The family name of the query and target are compared.  If they are the same then the score is 0.  If they are different the score is 1. If either family name is undeterminable the score is 0.
